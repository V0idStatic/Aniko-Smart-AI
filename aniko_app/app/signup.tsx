...
export default function SignUpScreen() {
  ...
  const checkUsernameExists = async (username: string): Promise<boolean> => {
    try {
      // Query auth.users metadata for existing username
  ...
  const handleSignup = async () => {
    try {
      ...
      // ==========================================
      // CHECK USERNAME IN PUBLIC.USERS TABLE
      // ==========================================
      ...
      if (userError) {
        console.error("⚠️ User record creation failed:", userError)
        // Auth user created but profile failed - user can update later
      }
        ...
        <View style={styles.card}>
          ...
          <View style={styles.inputGroup}>
            ...
            {errors.username ? (
              ...
              <Text style={styles.helperText}>3-20 characters (letters, numbers, underscore)</Text>
            )}
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            {errors.password ? (
              ...
              <Text style={styles.helperText}>At least 8 characters with uppercase, lowercase, number & special char</Text>
            )}
